...
/**
 * Typografia artykułu — brak `@tailwindcss/typography` w projekcie.
 * Nagłówki celowo idą `font-sans` (Plex): globalny `globals.css` daje h1–h4
 * Oswalda, a design bloga jest na zwykłym, nieskondensowanym boldzie.
 */
const PROSE = [
  "flex flex-col gap-5 text-[0.95rem] leading-[1.75] text-muted-foreground sm:text-base",
  // Puste nagłówki/akapity z CMS-a nie mogą zostawiać sierocej kreski ani dziury.
  "[&_:is(h2,h3,h4):empty]:hidden [&_p:empty]:hidden",
  // h2 z czerwoną kreską nad nagłówkiem
  ...
  // listy z kwadratowym czerwonym punktorem
