...
const PROSE = [
  "flex flex-col gap-5 text-base leading-relaxed text-muted-foreground",
  ...
  "[&_h2]:before:absolute [&_h2]:before:left-0 [&_h2]:before:top-0 [&_h2]:before:h-1 [&_h2]:before:w-10 [&_h2]:before:bg-primary [&_h2]:before:content-['']",
